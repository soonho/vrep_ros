...
PotentialField consensus() {
    PotentialField temp;
    double ux = gain_x * (0.5 * ((pf_q1.x - 0.0) - (pf_p1.x + 0.0)) + 0.5 * ((pf_r1.x - 0.0) - (pf_p1.x + 0.0))) - gain_vx * (pf_p1.vx);
    double uy = gain_y * (0.5 * ((pf_q1.y - 0.0) - (pf_p1.y + 0.0)) + 0.5 * ((pf_r1.y - 0.0) - (pf_p1.y + 0.0))) - gain_vy * (pf_p1.vy);
