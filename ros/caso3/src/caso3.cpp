...
{	
    	...
    	while(ros::ok())
	{
		...
		ux_quad1 = 0.05*(- quad1_x + p3dx1_x + 0.0 - 1.0 - quad1_x + quad2_x + 0.0 - 1.5 - 2*quad1_vx);
		uy_quad1 = 0.05*(- quad1_y + p3dx1_y + 0.0 - 0.0 - quad1_y + quad2_y + 0.0 - 0.0 - 2*quad1_vy);
		uz_quad1 = 0.50*(- quad1_z + p3dx1_z + 1.0 - 0.0 - quad1_z + quad2_z + 1.0 - 1.0 - 2*quad1_vz);

		ux_quad2 = 0.05*(- quad2_x + p3dx1_x + 1.5 - 1.0 - quad2_x + quad1_x + 1.5 - 0.0 - 2*quad2_vx);
		uy_quad2 = 0.05*(- quad2_y + p3dx1_y + 0.0 - 0.0 - quad2_y + quad1_y + 0.0 + 0.0 - 2*quad2_vy);
		uz_quad2 = 0.50*(- quad2_z + p3dx1_z + 1.0 - 0.0 - quad2_z + quad1_z + 1.0 - 1.0 - 2*quad2_vz);
