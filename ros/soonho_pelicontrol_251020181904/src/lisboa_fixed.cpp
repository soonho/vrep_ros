...
int main (int argc, char** argv)
{
    ...
    while(ros::ok()) {
        ...
        ux   = 0.5 * (2   - quad1_x) - 0.8 * (quad1_vx);
        uy   = 0.5 * (0   - quad1_y) - 0.8 * (quad1_vy);
	uz   = 1 * (0.6 - quad1_z) - 0.5 * (quad1_vz) + 0.465;
        uyaw = 1 * (0 - quad1_yaw) - 0.5 * (quad1_vyaw);
